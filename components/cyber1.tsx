    ...
    <div className="min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-6xl">
          ...
          {/* Left white card - 7 columns */}
          <div className="bg-white py-8 sm:py-12 lg:py-16 pl-6 sm:pl-8 lg:pl-12 pr-8 sm:pr-12 lg:pr-24 rounded-xl shadow-2xl col-span-12 lg:col-span-7">
            <div className="mb-4">
          ...
          {/* Right side - Single Image - 5 columns */}
          <div className="relative col-span-12 lg:col-span-5">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg flex flex-col-reverse lg:flex-col-reverse items-center overflow-hidden">
              {/* Text Content */}
              <div className="flex flex-col justify-center items-center text-center gap-4 p-6 w-full">
                ...
                <Link
                  ...
                  className="text-red-600 dark:text-red-400 font-semibold underline hover:text-red-700 dark:hover:text-red-300 transition"
                  target="_blank"
                >
              ...
              {/* Logo / Image */}
              <div className="flex justify-center items-center w-full p-1 bg-gray-50 dark:bg-gray-800">
                <Image
                  src="/images/Sadaiv_logo.png"
                  alt="Cybersecurity"
                  width={400}
                  height={400}
                  className="object-contain max-h-72 sm:max-h-96 lg:max-h-[400px] w-auto"
                  priority
                />
              </div>
            </div>
