        ...
        <div className="space-y-12 sm:space-y-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8 border-b pb-4">
            <div className="flex-1 max-w-md">
              ...
              <div>
                <span className="text-gray-800 font-medium mb-6 sm:mb-8 leading-relaxed p-4">
                  <Quote className="rotate-180 text-red-500" />
                  Sadaiv Satya Media and Broadcasting Pvt Ltd is a dynamic media
                  company focused on honest broadcasting and content creation
                  that empowers communities. Join us in a replay of this webinar
                  to see how to collaborate from the first line of code to
                  impactful media campaigns sent in less than 15 minutes, using
                  our contact form to kickstart your media journey.<Quote className="text-red-500" />
            ...
            <div className="flex-1 max-w-md">
              ...
              <p className="text-gray-800 font-medium mb-6 sm:mb-8 leading-relaxed p-1">
                ...
                <span className="text-base sm:text-lg">
                  Sadaiv Yuva Foundation, a 12A/80G/CSR-approved non-profit, is
                  more than a foundation—it’s a movement. When we receive your
                  inquiry, our dedicated team will guide you toward youth
                  leadership programs, skill development, and global impact
                  initiatives that nurture young minds as change-makers for
                  tomorrow.
                </span>{" "}
                <span className="text-5xl sm:text-6xl text-red-500">"</span>
              </p>
