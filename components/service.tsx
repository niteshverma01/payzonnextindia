...
const services: Service[] = [
  {
    ...
    description:
      "We provide reliable and secure services, ensuring peace of mind with every solution we deliver.",
  ...
  },
  {
    ...
    description:
      "Dedicated to Excellence in Customer Support and Service Service Beyond Compare: World-Class Support & Experience",
  ...
  },
  {
    ...
    description:
      "Future-driven technology solutions designed to meet evolving market demands and empower your business growth.",
  ...
  },
  {
    ...
    description:
      "Equipped with all the necessary global certifications and documentation to conduct business seamlessly worldwide.",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 ">
        {services.map((service) => (
          ...
          >
            ...
            {/* Blue Overlay (center from scale animation) */}
            <div
              className="absolute inset-0 bg-gradient-to-b from-blue-600 to-blue-700 
                opacity-0 scale-75 group-hover:opacity-90 group-hover:scale-100 
